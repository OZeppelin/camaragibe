...
<div id="main">
	...
	<?php 
		...
		echo HtmlHelper::form_post( HtmlHelper::link('estabelecimento/processo.php?t=inserir'), array('titulo'), array('name' => 'form', 'id' => 'form') ); 
		echo HtmlHelper::input_text('Raz&atilde;o Social', 'titulo', false, 255);
	?>
