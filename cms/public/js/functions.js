...
function salvarOrdem(){
	$.post("destaque/processo.php?t=ordem", 
	{
		ordem : $("#ordem").val()
	},function(msg)
	{
...
function alteraTipo(tipo) {
	...
	// Se não quiser postar nenhuma imagem ou vídeo
	else {
		$(".imagem-noticia").hide();
		$(".video-noticia").hide();	
	}
...
//cor nos links da listagem
function color(id){
	id.style.background = '#F7F7F7';//E8EEF7
}
function color2(id){
	id.style.background = '#F7F7F7';
	id.style.fontWeight = 'bold';
}
function colorBranco(id){
...
var erros = '';
	...
	//if (! emailCheck ($("#news-email").val())) erros += "- E-mail invalido \n\r";
	//if (erros == ""){
		$.post("processo.php", 
			{	
...
function carregaCampoImagem(tipo) {
