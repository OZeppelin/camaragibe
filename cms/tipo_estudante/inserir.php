...
<div id="main">
	...
	<?php 
		...
		echo HtmlHelper::form_post( HtmlHelper::link('tipo_estudante/processo.php?t=inserir'), array('titulo'), array('name' => 'form', 'id' => 'form') ); 
		echo HtmlHelper::input_text('Tipo de Estudante', 'titulo', false, 255);
	?>
